...
const fullpage = require("./js/fullpage.min");
const videojs = require("video.js/dist/video.min");
...
$(function () {
    ...
    Trigger.on("click", Trigger.handler);
    ...
    let Navigation = {
        ...
        Share: {
            ...
            init() {
                ...
                this.init = null;
                $(".share-cancel").on("click", Navigation.closeBar);
        ...
        init() {
            ...
            this.navMask.on("click", this.closeBar);
            this.closeBtn.on("click", this.closeBar);
    ...
    let Guidance = {
        ...
        start() {
            this.scroll.fadeIn(1000).on("click", (e) => {
    ...
    let Ceremony = {
        ...
        init() {
            ...
            // card
            this.cardWrap.on("mousewheel", (e) => {
                e.stopPropagation();
            })
            this.cardFlip.on("click", (e) => { Ceremony.cardWrap.toggleClass("reverse"); Navigation.clickAudio.play(); });
            this.backToVideo.on("click", (e) => { Fullpage.moveSlideLeft(); });
            ...
            this.leftList.init = function () {
                ...
                Ceremony.leftListItem.on("click", (e) => {
            ...
            this.rightSlider.init = function () {
                ...
                Ceremony.rightSliderItem.on("click", (e) => {
            ...
            this.rightHandlebar.on("click", (e) => {
    ...
    let Dictation = {
        ...
        init() {
            ...
            this.DictationTrigger.on("click", (e) => {
                Trigger.handler();
                this.primary.play();
            });
    ...
    let Fullpage = new fullpage('main', {
        ...
        onLeave: function (origin, destination, direction) {
            ...
            if (destination.anchor === "ceremony") {
                Ceremony.introVideo.each((index, item) => {
                    item.play();
                });
            } else {
                Ceremony.introVideo.each((index, item) => {
